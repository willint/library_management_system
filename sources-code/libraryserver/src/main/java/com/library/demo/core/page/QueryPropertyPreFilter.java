...
import com.library.demo.core.utils.fastjson.ComplexPropertyPreFilter;
...
public class QueryPropertyPreFilter implements PropertyPreFilterable {
  ...
  public void init(String queryPropertyStr) {
    ...
    if (!StringUtils.isEmpty(this.queryPropertyStr)) {
      this.queryPropertyStr =
          this.queryPropertyStr.substring(0, this.queryPropertyStr.length() - 1);
