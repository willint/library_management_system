...
export default {
  ...
  computed: {
    username() {
      ...
      if (loginInfo.user.username != null) {
        return loginInfo.user.username;
      } else {
        return loginInfo.user.phone;
      }
    }
  },
  methods: {
    ...
    saveEdit() {
      ...
      _this.$refs["form"].validate(valid => {
        if (valid) {
          apiService.post("/system/user/updateMyPwd", _this.pwdform, function(
            data
          ) {
